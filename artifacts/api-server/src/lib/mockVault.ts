 ...
 *
 * Returns a realistic snapshot of Western Sydney property data as if pulled from a live VaultRE CRM feed.
 * Properties reflect the Penrith, Colyton, Blacktown, and surrounding Greater Western Sydney market circa 2026.
...
export const MOCK_VAULT_LISTINGS: MockVaultListing[] = [
  // --- Penrith ---
  {
    ...
    inspectionTimes: ["Saturday 11:00-11:30am", "Sunday 1:00-1:30pm"],
    status: "active",
  ...
  // --- Colyton ---
  {
    ...
    inspectionTimes: ["Saturday 12:00-12:30pm"],
    status: "active",
  ...
  },
  {
    ...
    inspectionTimes: ["Tuesday 4:30-5:00pm", "Saturday 9:30-10:00am"],
    status: "active",
  ...
  },
  {
    ...
    agentName: "Lisa Nguyen",
    agentMobile: "0423 412 223",
    inspectionTimes: ["Thursday 5:30-6:00pm", "Saturday 11:30am-12:00pm"],
    status: "active",
  ...
  // --- St Marys ---
  {
    ...
    agentName: "David Santos",
    agentMobile: "0434 523 334",
    inspectionTimes: ["Saturday 10:30-11:00am", "Sunday 2:00-2:30pm"],
    status: "under_offer",
  ...
  },
  {
    ...
    agentName: "Rachel Kim",
    agentMobile: "0445 634 445",
    inspectionTimes: ["Monday 5:00-5:30pm", "Saturday 12:30-1:00pm"],
    status: "active",
  ...
  // --- Glenmore Park ---
  {
    ...
    agentName: "Mark Thompson",
    agentMobile: "0412 301 112",
    inspectionTimes: ["Saturday 1:00-1:30pm", "Sunday 10:00-10:30am"],
    status: "active",
    description: "Premium family home in the highly desirable Glenmore Park estate. Open-plan design with high ceilings, chef's kitchen, alfresco entertaining overlooking a large yard, and quality finishes throughout. Close to Glenmore Park Town Centre.",
  ...
  // --- Kingswood ---
  {
    ...
    agentName: "Lisa Nguyen",
    agentMobile: "0423 412 223",
    inspectionTimes: ["Wednesday 12:00-12:30pm", "Saturday 2:00-2:30pm"],
    status: "active",
    description: "Stylish 3-bedroom townhouse in a modern complex. Two-storey design, open-plan kitchen and living, private courtyard, single lock-up garage. Walking distance to Western Sydney University and Kingswood station.",
