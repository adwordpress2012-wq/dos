...
export default function Home() {
  return (
    <AppLayout>
      ...
      <section className="py-24 border-t border-border" style={{ background: "rgba(255,255,255,0.015)" }}>
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4 leading-tight">
                Your Agency.<br />
                <span style={{ color: "#00d1b2" }}>In Every Buyer's Pocket.</span>
              </h2>
              ...
              <ul className="space-y-4 mb-10">
                {[
                  { icon: <Smartphone className="w-4 h-4" />, title: "Your brand in the App Store", desc: "Custom icon, your agency name, your colours — looks identical to Domain or REA." },
                  { icon: <Bell className="w-4 h-4" />, title: "Push notifications to buyers", desc: "Send \"New listing — open Saturday\" directly to every buyer who downloaded your app. No algorithm. Direct." },
                  { icon: <MessageSquare className="w-4 h-4" />, title: "Sarah built in", desc: "Sarah AI is embedded — buyers can chat or call 24/7 without ever leaving your app." },
                  { icon: <CalendarCheck className="w-4 h-4" />, title: "QR code for open homes", desc: "Print a QR code sign for every open home. Buyers scan and download instantly — you own that relationship forever." },
                ].map(item => (
              ...
              <div className="flex flex-wrap items-center gap-3 mb-6">
                ...
                <a href="https://directiveos.com.au" target="_blank" rel="noopener noreferrer"
                  className="flex items-center gap-2.5 px-4 py-2.5 rounded-xl transition-all hover:scale-105"
                  ...
                  <div className="leading-none">
                    <div className="text-[9px] text-white/70 uppercase tracking-wider">Download on the</div>
            ...
            <div className="flex justify-center lg:justify-end">
              <div className="relative">
                ...
                <div className="absolute inset-0 rounded-[3rem] pointer-events-none"
                  style={{ background: "radial-gradient(ellipse at center, rgba(0,209,178,0.2) 0%, transparent 70%)", filter: "blur(40px)", transform: "scale(1.2)" }} />

                {/* Phone frame */}
                <div className="relative rounded-[2.5rem] overflow-hidden shadow-2xl"
                  style={{ width: 260, background: "#0a0f1a", border: "2px solid rgba(255,255,255,0.12)" }}>

                  {/* Status bar */}
                  <div className="flex items-center justify-between px-5 pt-4 pb-2" style={{ background: "#0a0f1a" }}>
                    <span className="text-white text-[10px] font-semibold">9:41</span>
                    <div className="w-20 h-5 rounded-full" style={{ background: "#1a1a1a" }} />
                    <div className="flex items-center gap-1">
                      <div className="w-3 h-2 rounded-sm" style={{ background: "rgba(255,255,255,0.6)" }} />
                    </div>
                  </div>

                  {/* App header */}
                  <div className="px-4 py-3" style={{ background: "#0d1424", borderBottom: "1px solid rgba(0,209,178,0.15)" }}>
                    <div className="flex items-center justify-between">
                      <div>
                        <div className="text-[10px] text-muted-foreground uppercase tracking-widest">Ray White</div>
                        <div className="text-white font-bold text-sm">Castle Hill</div>
                      </div>
                      <div className="w-8 h-8 rounded-lg flex items-center justify-center" style={{ background: "#FFD000" }}>
                  ...
                  <div className="mx-3 mt-3 px-3 py-2 rounded-xl flex items-center gap-2"
                    ...
                    <span className="text-xs" style={{ color: "#00d1b2" }}>Sarah is online · Chat 24/7</span>
                  </div>

                  {/* Listing cards */}
                  {[
                    { addr: "14 Blackwood Ct", suburb: "Castle Hill", price: "$1,895,000", beds: 5, img: "https://images.unsplash.com/photo-1570129477492-45c003edd2be?w=400&q=70" },
                    { addr: "3/88 Castle St", suburb: "Baulkham Hills", price: "$1,195,000", beds: 3, img: "https://images.unsplash.com/photo-1600047509807-ba8f99d2cdde?w=400&q=70" },
                  ].map(l => (
                    <div key={l.addr} className="mx-3 mt-3 rounded-xl overflow-hidden"
                      style={{ border: "1px solid rgba(255,255,255,0.08)" }}>
                      <img src={l.img} alt={l.addr} style={{ width: "100%", height: 80, objectFit: "cover" }} />
                      <div className="px-3 py-2" style={{ background: "#0d1424" }}>
                        <div className="text-white text-[11px] font-semibold">{l.addr}</div>
                        <div className="text-muted-foreground text-[10px]">{l.suburb}</div>
                        <div className="flex items-center justify-between mt-1">
                          <span className="text-[11px] font-bold" style={{ color: "#FFD000" }}>{l.price}</span>
                          <span className="text-[10px] text-muted-foreground">🛏 {l.beds} bed</span>
                        </div>
                      </div>
                    </div>
                  ))}
                  ...
                  {/* Bottom nav */}
                  <div className="flex items-center justify-around px-2 py-3 mt-3" style={{ borderTop: "1px solid rgba(255,255,255,0.06)", background: "#0a0f1a" }}>
                    {[
                      { icon: "🏠", label: "Home" },
                      { icon: "🔍", label: "Search" },
                      { icon: "💬", label: "Sarah" },
                      ...
                      <div key={n.label} className="flex flex-col items-center gap-0.5">
                        ...
                        <span className="text-[8px] text-muted-foreground">{n.label}</span>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div className="absolute -top-3 -right-3 px-3 py-1.5 rounded-full text-xs font-bold"
                  style={{ background: "linear-gradient(135deg, #00d1b2, #00b89c)", color: "#000" }}>
                  Live Demo
                </div>
              </div>
            </div>
