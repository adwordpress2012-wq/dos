...
const DEMOS = [
  ...
  {
    id: "demo-2",
    name: "Standard Demo Two — Agent & Caller",
    tagline: "AI Receptionist · DOS Branding",
    industry: "Real Estate",
    location: "Australia-wide",
    desc: "Second standard demo — identical layout to the R&W Rooty Hill page but in DOS branding. Uses 'Agent' and 'Caller' throughout. Same How It Works flow with email mockup and app notification card. Ready to send to any prospect.",
    href: `${BASE}/demo-2`,
    external: false,
    badge: "Template",
    badgeColor: "#00d1b2",
    ...
    features: ["How It Works Flow", "Live Chat Sarah", "Email Mockup", "App Notification Card"],
  },
  {
    id: "ray-white-ug",
